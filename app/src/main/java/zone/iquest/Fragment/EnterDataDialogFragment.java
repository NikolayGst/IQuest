...
import zone.iquest.AppIntro;
import zone.iquest.R;
import zone.iquest.Utils.PreferenceHelper;


public class EnterDataDialogFragment extends SupportBlurDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.enter_data_dialog_layout, null);
            ...
            public void onClick(View v) {
                ...
                if (isEmailValid(email)) {
                    if (!name.isEmpty() && !email.isEmpty() && !phone.isEmpty()) {
                        ...
                        getActivity().startActivity(new Intent(getContext(), AppIntro.class));
                        getActivity().finish();
